        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span
              ...
              style={{ fontFamily: 'Rajdhani, sans-serif', color: '#3B82F6' }}
            >
              The Loop
            </span>
          </div>
          ...
          {steps.map(({ num, title, desc, color }, i) => (
            <div key={num} className="relative flex flex-col items-center text-center px-6">
              ...
              <div
                ...
                style={{
                  background: `rgba(${color === '#F97316' ? '249,115,22' : color === '#3B82F6' ? '37,99,235' : color === '#F59E0B' ? '245,158,11' : '16,185,129'}, 0.12)`,
              ...
              <h3
                ...
                style={{ fontFamily: 'Orbitron, monospace', color: '#F0F4FF', fontSize: '0.9rem' }}
              >
                {title}
              </h3>
              <p
                className="text-sm leading-relaxed"
                style={{ color: '#8BA3C7', fontFamily: 'Rajdhani, sans-serif', fontWeight: 400 }}
              >
                {desc}
              </p>
              ...
              {i < steps.length - 1 && (
                <div className="md:hidden text-2xl my-4" style={{ color: '#4A6585' }}>↓</div>
              )}
            </div>
          ))}
        </div>
        ...
        >
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p
                className="text-sm"
                style={{ color: '#8BA3C7', fontFamily: 'Rajdhani, sans-serif' }}
              >
